...
class autoCellSix:  UITableViewCell {
    
    var leftTitle: UILabel?
    var rightTitle: UILabel?
    var iconImage: UIImageView?
    
    var cons_width:NSLayoutConstraint?
    var cons_height:NSLayoutConstraint?
    ...
    func makeLayout() {
        ...
        cons_width = NSLayoutConstraint(item: _img, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: 40)
        
        cons_height = NSLayoutConstraint(item: _img, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: 40)
    ...
    public func updateConst() {
        ...
        cons_width?.constant = w_h
        cons_height?.constant = w_h
